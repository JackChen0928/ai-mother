...
public class CodeFileSaverExecutor {
    ...
    public static File executorSaver(Object codeResult, CodeGenTypeEnum codeGenType){
        switch (codeGenType){
            case HTML:
                return htmlCodeFileSaverTemplate.saveCode((HtmlCodeResult) codeResult);
            case MULTI_FILE:
                return multiFileCodeFileSaverTemplate.saveCode((MultiFileCodeResult) codeResult);
            default:
